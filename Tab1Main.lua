...
-- Fix: Se A non è ancora pronto, aspetta un istante
if not A then task.wait(0.1) A = _G.A end

-- 1) Pulsanti della TopBar (Quelli che vedi nell'immagine)
...
-- 2) Contenitore Principale (Quello che manca nell'immagine)
...
-- Logica Enable (Sistemata senza errori)
